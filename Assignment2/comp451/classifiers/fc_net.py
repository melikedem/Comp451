...
class ThreeLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=(64, 32), num_classes=10,
        ...
        W3 = weight_scale * np.random.randn(hidden_dim[1], num_classes)
    ...
    def loss(self, X, y=None):
        ...
        scores, cache3 = affine_forward(layer2, self.params["W3"], self.params["b3"])
        ...
        loss = loss + 0.5 * self.reg *(np.sum(self.params["W1"]**2)+np.sum(self.params["W2"]**2)+ np.sum(self.params["W3"]**2)) 
